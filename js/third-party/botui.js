...
function bot_ui_ini() {
  ...
  botui.message
    ...
    .then(function () {
      botui.message
        .add({ delay: 1100, content: "我是一名逗逼开发工程师" })
        .then(function () {
          botui.message
  ...
  var sure = function () {
    ...
    secondpart = function () {
      botui.message
        .add({ delay: 1500, content: "主攻 Java 和 Python 语言" })
            .then(function () {
              botui.message
                .add({ delay: 1200, content: "喜欢看悬疑剧和动漫" })
                            .then(function () {
                              botui.action
                                .button({
                                  delay: 1100,
      ...
      botui.message
        ...
        .then(function () {
          botui.action
            .button({
              delay: 1500,
              action: [{ text: "📫 另一个博客", value: "why-cat" }]
            })
            .then(function (a) {
              fourthpart();
            });
    ...
    fourthpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content: "https://blog.csdn.net/minkeyto "
        })
        .then(function () {
          botui.message
            .add({ delay: 1100, content: "以技术知识分享为主！goitman 以实战为主" })
            .then(function () {
              botui.action
                .button({
                  delay: 1500,
    ...
    fifthpart = function () {
      botui.message
        .add({ delay: 1e3, content: "因为项目挂载在 Github 上，你懂得" })
        .then(function () {
          botui.message.add({
            delay: 1600,
            content: "那么，留个评论，赏个赞吧 😃"
          });
        });
    };
}
